                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <a href="{{ route('CategoriesT') }}"><button class="btn btn-sm btn-info pull-right">Create a Category</button></a>
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Category</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/Category/'.$item->sub_img) }}" width="40px" alt=""></td>
                                            {{-- <td>
