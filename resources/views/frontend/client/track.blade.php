...
@section('content')
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ url('payment/update/'.$items->id) }}" method="post" enctype="multipart/form-data"
                                                        class="form-group">
                                                        @csrf
                                                        <input class="form-control" type="file" name="payment_slip"
                                                            id="" required>
                                                        <button type="submit" style="border-radius: 50px; float:right"
    ...
    <script src="{{ asset('js/jquery.mr.js') }}"></script>
@endsection
