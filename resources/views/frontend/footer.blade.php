    ...
    <footer class="container-fluid p-0">
        ...
        <div class="footer_top">
            <p class="p-0 m-0">We deliver Insight Intelligent Technology Solutions™ expertise.</p>
        </div>
        ...
        <div class="social_icon_wrapper">
            <div class="footer_social_icon">
                <ul>
                    <li><a href="{{ url('https://www.linkedin.com/company/ngenitltd') }}"><i class="fa-brands fa-linkedin"></i></a></li>
                    <li><a href="{{ url('https://www.facebook.com/ngenitltd/') }}"><i class="fa-brands fa-square-facebook"></i></a></li>
                    <li><a href="{{ url('https://twitter.com/ngenit?lang=en') }}"><i class="fa-brands fa-twitter"></i></a></li>
