<script>
    ...
    $(document).on('click', '#addToBasket', function(event) {
        ...
        // var takeNumber = cartCount.innerText;
        // var onlyNumber = parseInt(takeNumber);
        // cartCount.innerText = onlyNumber + 1;
        ...
        let href = $(this).attr('data-attr');
         ...
         $.ajax({
               type : "POST",
               data : {id:id, name:name,price:price,image:image,quantity:quantity,"_token": "{{ csrf_token() }}"} ,
   ...
   <!--For Country and State-->
    ...
    <div id="backIcon" class="d-none">
        <a  name="backIcon" href="javascript:history.back()" class="backPage"><i
