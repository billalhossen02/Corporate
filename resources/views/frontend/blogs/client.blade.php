        ...
        <div class="row">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <img class="img-fluid" src="{{$story[0]->image ? asset ('storage/Client/' . $story[0]->image) : asset('assets/frontend/image/Logo/logo.png')}}" alt="">

                </div>
            </div>
            <div class="byTopics col-12">
                <span class="pull-right" style="padding: 0px 10px;">{{$story[0]->created_at}}</span>
                <div class="bySocial">
