                        ...
                        <div id="filter_category">
                            @foreach ($brands as $item)
                                ...
                                <div class="form-check p-0 m-0">
                                    <input type="checkbox" name="filterbrand[]" class="custom" value="{{ $item->title }}"
                                ...
                                @foreach ($categories as $item)
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input custom" name="filtercategory[]"
                                            value="{{ $item->category }}"
                                            @if (in_array($item->sub_category, $checked)) checked @endif />
                                        {{ $item->sub_category }}
                                    </div>
                                @endforeach
                                {{-- <div class="product_apply_filter_btn d-flex">
            ...
            @foreach ($products as $item)
                <div class="product_content_item row">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <img class="img-fluid" src="{{ asset('storage/Product/' . $item->image) }}" alt="">
                    </div>
