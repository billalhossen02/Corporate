...
<div class="popup_modal">
    ...
    <div class="popup_modal_content">
        <div class="popup_modal_content_wrapper">
            ...
            <div class="modal_product_item">
                <div class="modal_product_item_left">
                    ...
                    <div class="modal_product_item_content">
                        <p style="font-size: 15px" class="modal_product_name" style="
                             display: -webkit-box;
                            -webkit-box-orient: vertical;
                            -webkit-line-clamp:2;
                             overflow: hidden;
                        ">{{ $data->title }}</p>
                        <p class="added_cart"><span><img src="{{ asset('assets/frontend/image/Logo/checkmark-blue.png') }}" alt=""></span>Added to Your Basket</p>
                    </div>
                </div>
                <div class="modal_product_item_right">
                    <div class="modal_product_details" style="padding: 0px 15px;">
                        <ul>
                            ...
                            <li> <div class="card_product_counter">
                                <form class="myForm"
                                style="display:flex;flex-direction: column;text-align:center;color:#ae0a46;font-size:14px;gap:10px;align-items: baseline;justify-content: flex-end;">
                                    ...
                                    <div class="popup_input">
                                        ...
                                        Quantity:<input type="number" min="1" style="width: 75px !important;
                                        height: 35px !important;"
                                        name="quantity" value="1"
                                        class="cart_input_popup" id="quantity" />
                                    </div>

                                    <div class="update_pop">
                                        <button class="d-none popup_update_bnt" value="{{ $data->id }}" id="up" onclick="alert()" style="all:unset;cursor:pointer;"
                                        type="submit">update</button>
                                    </div>
                                </form>
                            </div></li>
                            <li><span>Total Price</span>$<span id="totalPrice">{{ number_format($data->price * 1) }} </span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            {{-- modal buttton --}}
            <p class="added_cart added_cart_mobile"><span><img src="{{ asset('assets/frontend/image/Logo/checkmark-blue.png') }}" alt=""></span>Added to Your Basket</p>
            ...
            <div class="modal_button_wrapper d-flux justify-content-between">
               ...
               <a style="color:#ae0a46" href="{{ route('cart.list') }}"><button type="button" class="common_button2 pr-5 pl-5" tabindex="0">View Cart</button></a>
